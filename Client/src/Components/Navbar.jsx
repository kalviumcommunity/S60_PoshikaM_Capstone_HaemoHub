...
function Navbar(){
    ...
    return(
        <div className="flex flex-row gap-x-40 inset-x-0 place-content-center top-0 fixed border border-orange-600">
            ...
            <Link to="./aboutUs">
            <button className="text-red-600 bg-white-700 px-4 py-2 transition duration-200 ease-in-out hover:text-white hover:bg-red-700 active:bg-red-700 focus:outline-non">About Us</button>
            </Link>
        </div>
    )
}
